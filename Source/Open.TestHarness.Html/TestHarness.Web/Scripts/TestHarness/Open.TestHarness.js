...
Type.registerNamespace('Open.TestHarness.Shell');Open.TestHarness.Shell.PanelResizeController=function(){this.$3=new Open.Core.UI.HorizontalPanelResizer(Open.Core.Css.selectFromId('sidebar'),'TH_SB');this.$3.add_resized(ss.Delegate.create(this,function(){
Open.TestHarness.Shell.PanelResizeController.$6();}));this.$3.set_minWidth(200);this.$3.set_maxWidthMargin(80);Open.TestHarness.Shell.PanelResizeController.$5(this.$3);Open.TestHarness.Shell.PanelResizeController.$6();this.$4=new Open.Core.UI.VerticalPanelResizer(Open.Core.Css.selectFromId('testHarnessLog'),'TH_OL');this.$4.add_resized(ss.Delegate.create(this,function(){
...
Open.TestHarness.CssSelectors.registerClass('Open.TestHarness.CssSelectors');Open.TestHarness.Elements.registerClass('Open.TestHarness.Elements');Open.TestHarness.Application.registerClass('Open.TestHarness.Application');Open.TestHarness.Shell.PanelResizeController.registerClass('Open.TestHarness.Shell.PanelResizeController');Open.TestHarness.CssSelectors.logTitlebar='#testHarnessLog .titlebar';Open.TestHarness.Elements.root='testHarness';Open.TestHarness.Elements.sideBar='sidebar';Open.TestHarness.Elements.sideBarToolbar='sidebarToolbar';Open.TestHarness.Elements.main='main';Open.TestHarness.Elements.mainToolbar='mainToolbar';Open.TestHarness.Elements.log='testHarnessLog';Open.TestHarness.Elements.outputLogTitle='outputLogTitle';Open.TestHarness.Application.$0=null;
