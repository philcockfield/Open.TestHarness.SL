...
// Source: http://expressionblend.codeplex.com/sourcecontrol/changeset/view/28511?projectName=expressionblend#494852
//
// NB: This is better to use than the obsolete 'ClipToBounds'
...
namespace Open.Core.Common.AttachedBehavior
{
    ...
    /// </summary>
    public class Clipping : Behavior<FrameworkElement>
    {
        /// <summary>Backing DP for the CornerRadius property</summary>
        public static readonly DependencyProperty CornerRadiusProperty = DependencyProperty.Register("CornerRadius", typeof(CornerRadius), typeof(Clipping), new PropertyMetadata(new CornerRadius()));
        
        /// <summary>Backing DP for the Margin property</summary>
        public static readonly DependencyProperty MarginProperty = DependencyProperty.Register("Margin", typeof(Thickness), typeof(Clipping), new PropertyMetadata(new Thickness()));
        ...
        {
            get { return (CornerRadius)this.GetValue(Clipping.CornerRadiusProperty); }
            set { this.SetValue(Clipping.CornerRadiusProperty, value); }
        }
        ...
        {
            get { return (Thickness)this.GetValue(Clipping.MarginProperty); }
            set { this.SetValue(Clipping.MarginProperty, value); }
        }
        ...
        protected virtual CornerRadius CalculatedCornerRadius
        {
            get
            {
                if (this.ReadLocalValue(Clipping.CornerRadiusProperty) == DependencyProperty.UnsetValue)
                {
